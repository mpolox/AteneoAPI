...
namespace AteneoAPI.Controllers
{
    ...
    public class CoursesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetCourse([FromRoute] int id)
        {
            ...
            var students = _context.StudentsCourses.Where(s => s.CourseId == id).Include(s => s.Student).Select(s => s.Student).ToList();

            var course = _context.Course.Where(c => c.CourseId == id).FirstOrDefault();
